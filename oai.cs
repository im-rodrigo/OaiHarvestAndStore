...
namespace oai
{
    ...
    public class OAI
    {
        ...
        {
            return ListIdentifiers(sPrefix, "", "", "", null);
        }
        public ListIdentifier ListIdentifiers(string sPrefix, string sset)
        {
            return ListIdentifiers(sPrefix, sset, "", "", null);
        }
        public ListIdentifier ListIdentifiers(string sPrefix, string sset, string sfrom, string suntil)
        {
            return ListIdentifiers(sPrefix, sset, sfrom, suntil, null);
        }
        public ListIdentifier ListIdentifiers(string sPrefix, string sfrom, string suntil)
        {
            return ListIdentifiers(sPrefix, "", sfrom, suntil, null);
        }
